...
Luckily, the matrix in AAA algorithm is quite specific and I don't need to keep
all of it in the memory. Also, I don't need the full SVD, only one right singular vector which corresponds to the smaller singular value.
